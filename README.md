...
[![Status](https://img.shields.io/badge/Status-Stable--v1.4.3-blue.svg)]()
...
| File | Description |
| :--- | :--- |
| [`core.sh`](core.sh) | **Sovereign Cognitive Core (v1.4.3)**: Agnostic, non-interactive engine and library. Manages dynamic Markdown-based memory bootstrapping, enforces OPSEC transports/Tor/ZDR routing, and orchestrates the **Sovereign Key Chest** (ChaCha20 + PBKDF2). |
...
| [`web-browse-mobile.sh`](tools/web-browse-mobile.sh) | **Mobile Stateless Browser Automation (v0.0.4)**: Pure Bash one-shot Chrome DevTools Protocol (CDP) engine with zero Node.js dependencies, zero privileges, SOCKS5 proxying, form interaction, screenshots, and PDFs. |
...
- **Project Phase**: Core Engine Stabilized, Hardened & Production-Ready (v1.4.3).
